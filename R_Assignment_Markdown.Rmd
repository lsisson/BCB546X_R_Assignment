...
## "fang_genotypes" has 986 columns and 2782 rows, "snps" has 15 columns and 983 rows, and both variables are data frames. The last line of code gives the number of occurences for each of the groups in fang_genotypes. There are 16 groups with varying number of occurences.
...
```
## The dimensions of the transposed variables are what we expected.
...
## Looking at distribution of SNPs on Chromosomes and Group Contribution to SNPs
