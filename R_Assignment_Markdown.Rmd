...
## Graphing the SNP_Status against Chromosome and Group
```{r}
ggplot(recoded_geno) + geom_bar(aes(x=Chromosome, fill=SNP_Status)) + ggtitle("SNP Status/Chromosome") + labs(x="Chromosome",y="SNP Status Counts")

ggplot(recoded_geno) + geom_bar(aes(x=Group, fill=SNP_Status)) + ggtitle("SNP Status/Group") + labs(x="Group",y="SNP Status Counts")
```
