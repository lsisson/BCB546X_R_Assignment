...
```{r}
ggplot(recoded_geno) + geom_bar(aes(x=Chromosome, fill=SNP_Status), position = "fill") + ggtitle("SNP Status/Chromosome") + labs(x="Chromosome",y="SNP Status Counts")
...
## Data Preparation is the same as for question 2
